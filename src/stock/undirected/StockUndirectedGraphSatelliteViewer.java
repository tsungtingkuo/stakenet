...
public class StockUndirectedGraphSatelliteViewer<V, E> extends JApplet {

    
	public static void main(String[] args) throws Exception {
		StockUndirectedGraph graph = StockUndirectedGraph.load("vertex.txt", "edge.txt");
		//StockUndirectedGraphSatelliteViewer.viewSocio(graph, 40, true, true);
		StockUndirectedGraphSatelliteViewer.viewEgo(graph, "2412", 1, false);
	}

    public static void viewEgoRandomly(StockUndirectedGraph graph, int level, boolean displayEdgeWeight) {
    	StockUndirectedGraph g = null;
   		g = StockUndirectedGraphSampler.sampleRandomly(graph, level);    		
		System.out.println("Vertex (ego) = " + g.getVertexCount());
		System.out.println("Edge (ego) = " + g.getEdgeCount());
		view(g, displayEdgeWeight);   	
    }

    public static void viewEgo(StockUndirectedGraph graph, String code, int level, boolean displayEdgeWeight) {
    	StockUndirectedGraph g = null;
   		g = StockUndirectedGraphSampler.sample(graph, code, level);    		
		System.out.println("Vertex (ego) = " + g.getVertexCount());
		System.out.println("Edge (ego) = " + g.getEdgeCount());
		view(g, displayEdgeWeight);   	
    }
	
    public static void viewEgoByName(StockUndirectedGraph graph, String name, int level, boolean displayEdgeWeight) {
    	StockUndirectedGraph g = null;
   		g = StockUndirectedGraphSampler.sampleByName(graph, name, level);    		
		System.out.println("Vertex (ego) = " + g.getVertexCount());
		System.out.println("Edge (ego) = " + g.getEdgeCount());
		view(g, displayEdgeWeight);   	
    }

    public static void viewSocio(StockUndirectedGraph graph, int minDegree, boolean clearGraph, boolean displayEdgeWeight) {
    	StockUndirectedGraph g = null;
    	if(clearGraph == true) {
    		g = StockUndirectedGraphSampler.sampleForViewer(graph, minDegree);    		    	
    	}
    	else {
    		g = StockUndirectedGraphSampler.sample(graph, minDegree);    		
    	}
	...
	public StockUndirectedGraphSatelliteViewer(StockUndirectedGraph graph, boolean displayEdgeWeight) {
        ...
        vv1.getRenderer().setVertexRenderer(new StockUndirectedGraphGradientVertexRenderer(Color.white, Color.white, true));
    ...
    public static void view(StockUndirectedGraph g, boolean displayEdgeWeight) {
        JFrame f = new JFrame();
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        StockUndirectedGraphSatelliteViewer<StockVertex, Number> sgsv = new StockUndirectedGraphSatelliteViewer<StockVertex, Number>(g, displayEdgeWeight);
