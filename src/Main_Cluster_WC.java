...
public class Main_Cluster_WC {
	...
	{		
		...
		Set<Set<StockVertex>> wcc = StockGraphStatistics.getConnectedComponent(g);
		Set<Set<StockVertex>> clusters = StockUtil.filterClusteringResult(wcc, bgc);
